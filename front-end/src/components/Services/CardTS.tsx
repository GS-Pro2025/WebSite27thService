        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
          ...
          <div className="flex items-center lg:order-1 col-span-1 lg:col-span-1">
            <div className="w-full px-4 md:px-6 lg:px-5">
              <div className="max-w-2xl mt-4 md:-mt-20">
                {/* Question Badge */}
                ...
                <div className="space-y-3 md:space-y-6">
                  <p className="text-[#0E6F7E] text-sm md:text-xl lg:text-2xl font-normal leading-relaxed bg-white/20 md:bg-white/10 backdrop-blur-sm p-4 md:p-6 rounded-xl md:rounded-2xl">
                  ...
                  <p className="text-[#0E6F7E] text-sm md:text-lg lg:text-xl leading-relaxed bg-white/20 md:bg-white/10 backdrop-blur-sm p-4 md:p-6 rounded-xl md:rounded-2xl">
                ...
                <div className="mt-6 md:mt-8 lg:hidden">
                  ...
                  <div className="flex items-center justify-center space-x-2 text-white mb-2">
                    <span className="text-xl md:text-3xl font-bold opacity-80 transform -rotate-6">
                      find
                    </span>
                  ...
                  <div className="flex items-center justify-center space-x-1">
                    <span className="text-yellow-400 text-2xl md:text-4xl font-bold transform rotate-6">
                      we move
                    </span>
                    <span className="text-blue-400 text-sm md:text-xl">
                      for
                    </span>
          ...
          <div className="hidden lg:flex relative justify-end lg:order-2">
            <div className="relative mt-28 -mr-28 px-0">
              <img
                src={ServiceImg}
