        ...
        <div className="max-w-md lg:max-w-lg">
          ...
          <div className="mb-8">
            <h1 className="text-white text-xl md:text-2xl lg:text-3xl xl:text-4xl font-light mb-2">
              mudanzas <span className="text-[#FFE67B] font-bold">únicas</span> y{' '}
              <span className="text-[#FFE67B] font-bold">personalizadas</span>
            </h1>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  required
                >
                  <option value="">Seleccionar tipo de mudanza</option>
