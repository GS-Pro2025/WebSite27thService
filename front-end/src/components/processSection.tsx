...
const ProcessSection: React.FC = () => {
  return (
    <section className="relative w-full -mt-83 z-10 bg-[#7AACAE] overflow-hidden pt-24 pb-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Texto informativo */}
          <div>
            ...
            <p className="text-white text-[20px] font-montserrat">
              Aquí en solo tres sencillos pasos te explicamos cómo tener una mudanza programada, rápida, sin estrés y con profesionales 100% capacitados.
            </p>
          </div>
        ...
        <div className="relative">
          ...
          <form className="bg-[#D9D9D9] rounded-lg p-6 pt-12 md:p-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <input type="text" placeholder="Origen" className="bg-white text-black rounded px-4 py-2" />
            <input type="text" placeholder="Destino" className="bg-white text-black rounded px-4 py-2" />
            <input type="text" placeholder="Tipo de mudanza" className="bg-white text-black rounded px-4 py-2 sm:col-span-2" />
            <input type="text" placeholder="Nombre" className="bg-white text-black rounded px-4 py-2" />
            <input type="tel" placeholder="Teléfono" className="bg-white text-black rounded px-4 py-2" />
            <input type="email" placeholder="Email" className="bg-white text-black rounded px-4 py-2 sm:col-span-2" />
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="150 -14.5 1450 320"><path fill="#f7f7f7" fill-opacity="1" d="M0,192L80,160C160,128,320,64,480,37.3C640,11,800,21,960,48C1120,75,1280,117,1360,138.7L1440,160L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
      </div>
